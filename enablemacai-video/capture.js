...
(async () => {
    const scenes = [
        { html: "scene_intro.html", duration: 5.33 },
        { html: "scene_1.html",     duration: 5.61 },
        { html: "scene_2.html",     duration: 6.05 },
        { html: "scene_3.html",     duration: 6.79 },
        { html: "scene_4.html",     duration: 7.85 },
        { html: "scene_5.html",     duration: 5.09 },
        { html: "scene_outro.html", duration: 5.66 },
    ];
    const fps = 15;
    const baseUrl = "http://localhost:8771/scenes/";
    const outDir = "/tmp/enablemacai_frames";
