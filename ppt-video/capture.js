...
(async () => {
    const scenes = [
        { html: "scene_intro.html", duration: 5.64 },
        { html: "scene_1.html",     duration: 7.02 },
        { html: "scene_2.html",     duration: 6.38 },
        { html: "scene_3.html",     duration: 5.90 },
        { html: "scene_4.html",     duration: 6.54 },
        { html: "scene_5.html",     duration: 7.90 },
        { html: "scene_outro.html", duration: 4.03 },
    ];
    const fps = 15;
    const baseUrl = "http://localhost:8772/scenes/";
    const outDir = "/tmp/ppt_frames";
