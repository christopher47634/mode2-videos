...
(async () => {
    const scenes = [
        { html: "scene_intro.html", duration: 7.27 },
        { html: "scene_1.html",     duration: 5.94 },
        { html: "scene_2.html",     duration: 4.03 },
        { html: "scene_3.html",     duration: 5.26 },
        { html: "scene_4.html",     duration: 5.02 },
        { html: "scene_5.html",     duration: 4.64 },
        { html: "scene_outro.html", duration: 3.43 },
    ];
    const fps = 15;
    const baseUrl = "http://localhost:8774/scenes/";
    const outDir = "/tmp/su7_frames";
