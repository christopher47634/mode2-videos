...
(async () => {
    const scenes = [
        { html: "scene_intro.html", duration: 6.48 },
        { html: "scene_1.html",     duration: 6.53 },
        { html: "scene_2.html",     duration: 6.84 },
        { html: "scene_3.html",     duration: 3.95 },
        { html: "scene_4.html",     duration: 2.82 },
        { html: "scene_5.html",     duration: 6.17 },
        { html: "scene_6.html",     duration: 6.37 },
        { html: "scene_7.html",     duration: 6.54 },
        { html: "scene_8.html",     duration: 6.03 },
        { html: "scene_9.html",     duration: 5.47 },
        { html: "scene_outro.html", duration: 4.68 },
    ];
    const fps = 15;
    const baseUrl = "http://localhost:8775/scenes/";
    const outDir = "/tmp/pangu_frames";
