...
(async () => {
    const scenes = [
        { html: "scene_intro.html", duration: 4.43 },
        { html: "scene_1.html",     duration: 6.27 },
        { html: "scene_2.html",     duration: 6.46 },
        { html: "scene_3.html",     duration: 5.98 },
        { html: "scene_4.html",     duration: 5.07 },
        { html: "scene_5.html",     duration: 6.61 },
        { html: "scene_outro.html", duration: 4.17 },
    ];
    const fps = 15;
    const baseUrl = "http://localhost:8770/scenes/";
    const outDir = "/tmp/noop_frames";
