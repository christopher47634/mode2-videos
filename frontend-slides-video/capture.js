...
const SCENES = [
  ...
  {name:'scene_1.html', dur:4.37},
  {name:'scene_2.html', dur:4.01},
  {name:'scene_3.html', dur:4.91},
  {name:'scene_4.html', dur:5.35},
  {name:'scene_5.html', dur:4.48},
  {name:'scene_6.html', dur:4.47},
  {name:'scene_outro.html', dur:3.0}
];
const FPS = 15;
const OUT_DIR = '/tmp/slides_frames';
(async () => {
  ...
  for (let si = 0; si < SCENES.length; si++) {
    ...
    await page.goto(`http://localhost:8779/scenes/${s.name}`, {waitUntil:'domcontentloaded', timeout:15000});
    await sleep(2000);
