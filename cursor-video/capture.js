...
(async () => {
    const scenes = [
        { html: "scene_intro.html", duration: 5.65 },
        { html: "scene_1.html",     duration: 6.17 },
        { html: "scene_2.html",     duration: 6.29 },
        { html: "scene_3.html",     duration: 6.07 },
        { html: "scene_4.html",     duration: 6.13 },
        { html: "scene_5.html",     duration: 5.32 },
        { html: "scene_outro.html", duration: 4.78 },
    ];
    const fps = 15;
    const baseUrl = "http://localhost:8773/scenes/";
    const outDir = "/tmp/cursor_frames";
