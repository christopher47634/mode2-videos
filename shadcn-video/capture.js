...
(async () => {
    const scenes = [
        { html: "scene_intro.html", duration: 4.56 },
        { html: "scene_1.html",     duration: 6.44 },
        { html: "scene_2.html",     duration: 6.91 },
        { html: "scene_3.html",     duration: 6.27 },
        { html: "scene_4.html",     duration: 5.88 },
        { html: "scene_outro.html", duration: 4.48 },
    ];
    const fps = 15;
    const baseUrl = "http://localhost:8768/scenes/";
    const outDir = "/tmp/shadcn_frames";
